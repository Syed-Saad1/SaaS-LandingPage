...
function Blog() {
  return (
    <div>
      ...
      {/* Cards */}
      <div className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-20 mt-16 px-5">
        {/* Card 1 */}
        <div className="w-full max-w-100 bg-[#F9F9F9] rounded-[32px]">
          <div className="flex justify-center">
            <img
              src="/Eimg.png"
              alt=""
              className="w-[90%] h-auto object-cover mt-4 rounded-2xl"
            />
          </div>
